...
INSERT INTO `dhsports_db`.`products`(`id`,`nombre`,`precio`,`descuento`,`deporteId`,`marcaId`,`categoriaId`,`talleId`,`colorId`,`userId`,`descripcion`,`deleted`) VALUES(1, 'camiseta Argentina', 20000, 10, 2, 1, 1, 5, 5, 1, 'camiseta campeon oficial 3 estrellas', 0);
INSERT INTO `dhsports_db`.`products`(`id`,`nombre`,`precio`,`descuento`,`deporteId`,`marcaId`,`categoriaId`,`talleId`,`colorId`,`userId`,`descripcion`,`deleted`) VALUES(2, 'botin preator', 30000, 20, 2, 1, 1, 19, 4, 2, 'botines preator azules', 0);
INSERT INTO `dhsports_db`.`products`(`id`,`nombre`,`precio`,`descuento`,`deporteId`,`marcaId`,`categoriaId`,`talleId`,`colorId`,`userId`,`descripcion`,`deleted`) VALUES(3, 'guantes everlast', 6000, 0, 3, 3, 3, 2, 1, 1, 'guentes de boxeo everlast', 0);
INSERT INTO `dhsports_db`.`products`(`id`,`nombre`,`precio`,`descuento`,`deporteId`,`marcaId`,`categoriaId`,`talleId`,`colorId`,`userId`,`descripcion`,`deleted`) VALUES(4, 'palo de hockey', 15000, 10, 4, 1, 4, null, 3, 2, 'palo de Hockey para cesped', 0);
INSERT INTO `dhsports_db`.`products`(`id`,`nombre`,`precio`,`descuento`,`deporteId`,`marcaId`,`categoriaId`,`talleId`,`colorId`,`userId`,`descripcion`,`deleted`) VALUES(5, 'pelota al rihla', 10000, 0, 2, 1, 4, null, 5, 1, 'pelota oficial del mundial qatar 2022', 0);